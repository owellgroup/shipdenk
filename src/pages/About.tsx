  ...
  <div className="min-h-screen bg-background">
    ...
    <div className="pt-36 md:pt-40 pb-16 px-4">
      <div className="container mx-auto max-w-3xl">
        <h1 className="font-display text-4xl font-bold text-foreground mb-4">About Ndiva Auto</h1>
        <p className="text-muted-foreground text-lg leading-relaxed mb-6">
          Ndiva Auto is a trusted pre-owned vehicle dealership based in Windhoek, Namibia. We specialize in sourcing quality German and Japanese vehicles, carefully inspected and competitively priced.
        </p>
